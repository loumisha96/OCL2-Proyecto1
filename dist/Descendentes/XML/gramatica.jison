...
LISTA_ID_OBJETO: identifier LISTA_ID_OBJETO' { $2=$2 + ' ' +$1 ; $$ = $2;}
            |     todos LISTA_ID_OBJETO' { $2=$2 + ' ' +$1 ; $$ = $2;}

LISTA_ID_OBJETO': identifier LISTA_ID_OBJETO' { $1=$1 + ' ' +$2 ; $$ = $1;}
            | todos { $$ = $1 }
;


OBJETOS: OBJETO OBJETOS' { $1.push($1); $$ = $2;};
